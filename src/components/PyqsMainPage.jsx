...
export const PyqsMainPage = () => {
  ...
  return (
    <div className="subject-notes-container">
      ...
      <p>Find and download past question papers for various subjects.</p>

      {/* Search Bar */}
        {/* INSTEAD OF THIS SEARCH BAR..THAT FILTER OPTION WILL COME AND ALL THE SUBJECT'S PYQS AS WELL */}
      <input
        type="text"
        ...
        {filteredSubjects.length > 0 ? (
          filteredSubjects.map((subject, index) => (
            <div key={index} className="subject-card">
              ...
              <button className="view-notes-btn">View</button>
            </div>
          ))
        ) : (
